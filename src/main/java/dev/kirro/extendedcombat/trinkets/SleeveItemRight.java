...
public class SleeveItemRight extends TrinketItem implements TrinketRenderer {


    public SleeveItemRight(Settings settings) {
        super(settings);
    }
    ...
    public void render(ItemStack itemStack, SlotReference slotReference, EntityModel<? extends LivingEntity> model, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, LivingEntity entity, float limbAngle, float limbDistance, float tickDelta, float animationProgress, float headYaw, float headPitch) {
        ...
        ItemStack stack = new ItemStack(ModItems.WOOL_SLEEVES_RIGHT);
        TrinketRenderer.translateToRightArm(matrices, (PlayerEntityModel<AbstractClientPlayerEntity>) model, (AbstractClientPlayerEntity) entity);
        ...
        renderer.renderItem(entity, stack,
                ModelTransformationMode.FIRST_PERSON_RIGHT_HAND, leftHanded, matrices, vertexConsumers, entity.getWorld(), light,
